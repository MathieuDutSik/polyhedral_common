...
CharacteristicVectorSetWellRoundedCV(MyMatrix<T> const &GramMat,
                                     bool const &spanning, std::ostream &os) {
...
MyMatrix<Tint> CharacteristicVectorSetCV(MyMatrix<T> const &GramMat,
  ...
  if (r == n) {
    ...
    return CharacteristicVectorSetWellRoundedCV<T, Tint>(GramMat, spanning, os);
  }
  CharVectSet_Accumulator<Tint> acc;
  ...
  MyMatrix<Tint> Vwr =
      CharacteristicVectorSetWellRoundedCV<T, Tint>(Gram1, spanning, os);
