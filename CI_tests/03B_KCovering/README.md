...
CoveringMaxdet.h) are compared with stored values. The default incremental
flip is cross-checked on two small cases against the recompute flip
(DATA/FlipMethod = recompute). In the plane the optima
