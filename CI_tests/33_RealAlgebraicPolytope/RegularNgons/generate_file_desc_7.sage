...
#   sin(2pi/7) = x
#   cos(2pi/7) = -8x^4 + 10x^2 - 5/2
#   sin(4pi/7) = -16x^5 + 20x^3 - 5x
#   cos(4pi/7) = 1 - 2x^2
#   sin(6pi/7) = 3x - 4x^3
#   cos(6pi/7) = 8x^4 - 8x^2 + 1
#
...
# x = sin(2*pi/7), minimal polynomial 64 x^6 - 112 x^4 + 56 x^2 - 7 = 0.
val = sin(2*pi/7)
l_coeff = [-7, 0, 56, 0, -112, 0, 64]
FileName = "FileDesc7"
