...
template <typename T> struct RequestCopositivity {
  T MaxNorm;
  bool DoListCone;
};
...
SingleTestResult<Tint> EnumerateCopositiveShortVector_Kernel(
    ...
    std::function<bool(MyMatrix<Tint> const &, MyMatrix<T> const &)> const
        &fInsert,
    std::function<SingleTestResult<Tint>(
        MyMatrix<Tint> const &, MyMatrix<T> const &)> const &fSingleTest) {
  struct DataPair {
    int idx;
...
T_CopositiveShortestVector(MyMatrix<T> const &eSymmMat,
  ...
  std::function<bool(MyMatrix<Tint> const &, MyMatrix<T> const &)> fInsert =
      [&](MyMatrix<Tint> const &TheBasis,
  ...
  std::function<SingleTestResult<Tint>(MyMatrix<Tint> const &,
                                       MyMatrix<T> const &)>
      fSingleTest =
          [&](MyMatrix<Tint> const &TheBasis,
...
SingleTestResult<Tint> TestCopositivity(MyMatrix<T> const &eSymmMat,
  ...
  std::function<SingleTestResult<Tint>(MyMatrix<int> const &,
                                       MyMatrix<T> const &)>
      fSingleTest =
          [&](MyMatrix<int> const &TheBasis,
              MyMatrix<T> const &eSymmMatB) -> SingleTestResult<Tint> {
...
EnumerateCopositiveShortVector(MyMatrix<T> const &eSymmMat,
  ...
  CopositivityEnumResult<Tint> res2 =
      EnumerateCopositiveShortVector_V2(eSymmMat, InitialBasis, CopoReq);
...
T_CopositiveShortestVector_V1(MyMatrix<T> const &eSymmMat,
  ...
  CopositivityEnumResult<Tint> CopoRes =
      EnumerateCopositiveShortVector(eSymmMat, InitialBasis, CopoReq);
  if (!CopoRes.test) {
