#ifndef INCLUDE_FUND_DOMAIN_VERTICES_H
#define INCLUDE_FUND_DOMAIN_VERTICES_H
...
template<typename T, typename Tint, typename Tgroup>
FundDomainVertex_FullInfo<T,Tint,Tgroup> get_fund_domain_full_info_noiso(MyMatrix<T> const& G, FundDomainVertex<T,Tint> const& vert)
{
