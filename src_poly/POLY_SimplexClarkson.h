...
/*
  ...
  POLY_DualDesc_reverse_search.h: when T is a field (and not a floating point type), the
...
//
// The reduction to the underlying ring, following the design of
// POLY_DualDesc_reverse_search.h: for a field T the rows are scaled once to ring elements
