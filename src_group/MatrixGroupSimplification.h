...
#ifdef DISABLE_DEBUG_MATRIX_GROUP_SIMPLIFICATION
#undef DEBUG_MATRIX_GROUP_SIMPLIFICATION
#endif

#ifdef DISABLE_DEBUG_MATRIX_DOUBLE_COSET_SIMPLIFICATION
#undef DEBUG_MATRIX_DOUBLE_COSET_SIMPLIFICATION
#endif
