...
/*
  ...
  ---
  It is a little bit concerning with respect to speed. But how could we do any better?
  What we need is some method for inserting an entry into the SolutionMatRepetitive
  to extend the range of applicability.
  That is the only realistic path since other appraoch will depend too much on heuristic
  stuff.
 */
template<typename T>
